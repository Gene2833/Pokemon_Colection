    ...
    return(
        <div>
            <Menu/>   
                ...
                <button className="button5" ><Link to={`/Pokemon`} style={{textDecoration:"none", color:"black"}}  >Ver Cartas</Link></button>
                <li><Link to={`/Create`} className="button6" style={{textDecoration:"none", color:"black"}} >Crea tu Pokemon</Link></li>
            ...
            <div className="principal1">
                ...
                <button className="button1"><Link to={`/Escarlata`}  style={{textDecoration:"none", color:"black"}}>Ver Cartas</Link></button>
            ...
            <div className="principal2">
                ...
                <li><Link to={`/Supremo`} className="button2" style={{textDecoration:"none", color:"black"}}> Ver Cartas</Link></li>
            ...
            <div className="principal3">
                ...
                <li><Link to={`/Tempestad`} className="button3" style={{textDecoration:"none", color:"black"}} >Ver Cartas</Link></li>
            </div>
            ...
            <div className="principal4">
                ...
                <li><Link to={`/Perdido`} className="button4"  style={{textDecoration:"none", color:"black"}}>Ver Cartas</Link></li>
